...
public class MyThreadPoolExecutor extends AbstractExecutorService {
     ...
     * allow access from ScheduledMyTPE.
     */
     ...
     * Package-protected for use by ScheduledMyTPE.
     */
     ...
     * ScheduledMyTPE to cancel delayed tasks.
     */
    void onShutdown() {
    }

    /**
     * State check needed by ScheduledMyTPE to
    ...
    public void shutdown() {
        ...
        try {
            ...
            onShutdown(); // hook for ScheduledMyTPE
        } finally {
            mainLock.unlock();
        }
        tryTerminate();
     ...
     * @see #setMyRejectedExecutionHandler
     */
    ...
    public String toString() {
        ...
        String rs = (runStateLessThan(c, SHUTDOWN) ? "Running" :
            (runStateAtLeast(c, TERMINATED) ? "Terminated" :
                "Shutting down"));
        return "DDD" + "@" + Integer.toHexString(hashCode()) +
            "[" + rs +
            ", pool size = " + nworkers +
